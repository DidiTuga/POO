...
public class GerirProfessor {
    ...
    private static void guardarP(ArrayList<Professor> professores) {
        try {
            ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("C:\\Users\\diogo\\OneDrive - Universidade da Beira Interior\\2ª Ano\\1ºSemestre\\POO\\TrabalhoPratico\\professor.dat"));
    ...
    public static ArrayList LerP() {
        ...
        try {
            ObjectInputStream is = new ObjectInputStream(new FileInputStream("C:\\Users\\diogo\\OneDrive - Universidade da Beira Interior\\2ª Ano\\1ºSemestre\\POO\\TrabalhoPratico\\professor.dat"));
