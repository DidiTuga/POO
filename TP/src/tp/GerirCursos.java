...
public class GerirCursos {
    ...
    public static void guardarC(ArrayList<Curso> Curso) {
        try {
            ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("C:\\Users\\diogo\\OneDrive - Universidade da Beira Interior\\2ª Ano\\1ºSemestre\\POO\\TrabalhoPratico\\curso.dat"));
    ...
    public static ArrayList lerC() {
        ...
        try {
            ObjectInputStream is = new ObjectInputStream(new FileInputStream("C:\\Users\\diogo\\OneDrive - Universidade da Beira Interior\\2ª Ano\\1ºSemestre\\POO\\TrabalhoPratico\\curso.dat"));
