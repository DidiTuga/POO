...
public class GerirAluno {
    ...
    private static void guardarAluno(ArrayList<Aluno> alunos) {
        try {
            ObjectOutputStream os = new ObjectOutputStream(new FileOutputStream("C:\\Users\\diogo\\OneDrive - Universidade da Beira Interior\\2ª Ano\\1ºSemestre\\POO\\TrabalhoPratico\\aluno.dat"));
    ...
    public static ArrayList LerA() {
        ...
        try {
            ObjectInputStream is = new ObjectInputStream(new FileInputStream("C:\\Users\\diogo\\OneDrive - Universidade da Beira Interior\\2ª Ano\\1ºSemestre\\POO\\TrabalhoPratico\\aluno.dat"));
